...
import {COMPLETEDJOBORDER_LIST, HOST} from '../constantsUrl/Urls';
...
export default class JobOrderList extends Component {
    ...
    requestURL(url = COMPLETEDJOBORDER_LIST,
    ...
    showMovieDetail(movie) {
        ...
        if (navigator) {
            navigator.push({
                ...
                params: {
                    url: `${HOST}jbpm/form/detail.do?processInstanceId=${movie.processInstanceId}`,
                    funcname: '工单详情',
                }
            });
        }
                    ...
                    <View style={styles.itemContent}>
                        <View style={styles.itemRow}>
                            <View style={{flex: 4,flexDirection:'row'}}>
                                <Text style={styles.itemHeader}>{movie.name}</Text></View>
    ...
    renderMovieList() {
        return (
            <View style={styles.msgContainer}>
                <TopBar name='已办列表' onBackUp={this.onBackUp}/>
                <ListView
